      ...
      <Screen>
        ...
        <View
          style={{
            ...
            padding: 15,
            borderRadius: 20,
            backgroundColor: 'rgba(17,35,66,0.80)',
            borderWidth: 1,
            borderColor: 'rgba(103,144,183,0.25)',
          }}
        >
          <Text
            style={{
          ...
          >
            Nel prossimo passaggio aggiungiamo Sala Operativa,
            Responsabile, Referente sito e contatti personalizzati.
          </Text>
        </View>
      </Screen>
    );
