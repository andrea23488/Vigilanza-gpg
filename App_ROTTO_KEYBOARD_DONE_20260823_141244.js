    ...
    return (
      <Screen>
        ...
        {[
          ...
          {
            label: 'ORARI E ATTIVITÀ',
            value: postazioneAttivitaDraft,
            setValue:
              setPostazioneAttivitaDraft,
            placeholder:
              '18:00 - Aprire cancello\n20:30 - Giro perimetrale\n22:00 - Chiudere ingresso...',
            multiline: true,
          },
          {
...
function Screen({
  ...
  const [keyboardVisibleScreen, setKeyboardVisibleScreen] =
    React.useState(false);

  React.useEffect(() => {
    const showSub = Keyboard.addListener(
      'keyboardDidShow',
      () => setKeyboardVisibleScreen(true)
    );

    const hideSub = Keyboard.addListener(
      'keyboardDidHide',
      () => setKeyboardVisibleScreen(false)
    );
  ...
  return (
    ...
    >
      ...
      {/* ===== CHIUDI TASTIERA GLOBALE ===== */}
      {keyboardVisibleScreen ? (
        <TouchableOpacity
          activeOpacity={0.82}
          ...
          style={{
            ...
            backgroundColor: 'rgba(14,59,87,0.96)',

            borderWidth: 1,
            borderColor: 'rgba(98,226,255,0.60)',
