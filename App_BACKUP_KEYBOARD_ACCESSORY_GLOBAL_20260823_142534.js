  ...
  if (screen === 'postazioneDettaglio') {
    ...
    return (
      <Screen>
        ...
        {[
          ...
          >
            ...
            <TextInput
              ...
              inputAccessoryViewID="postazioniKeyboardAccessory" 
              returnKeyType={
                campo.multiline
                  ? 'default'
                  : 'done'
        ...
        <InputAccessoryView
          nativeID="postazioniKeyboardAccessory"
        >
          <View
            style={{
              minHeight: 48,
          ...
          >
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor:
                  'rgba(20,130,166,0.96)',

                borderWidth: 1,
                borderColor:
                  'rgba(107,231,255,0.64)',
              }}
            >
              <Ionicons
                name="checkmark"
