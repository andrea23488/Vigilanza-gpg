...
function HomeServiceCard({ icon, title, subtitle, onPress, wide = false }) {
  return (
    <TouchableOpacity
      ...
      style={{
        width: wide ? '100%' : '48.5%',
        minHeight: wide ? 86 : 138,
        backgroundColor: '#091a38',
        borderRadius: 22,
        borderWidth: 1,
        borderColor: 'rgba(82, 145, 255, 0.48)',
        padding: 14,
        marginBottom: 12,
    ...
    >
      <View
        style={{
          ...
          borderWidth: 1,
          borderColor: 'rgba(105, 167, 255, 0.38)',
          shadowColor: '#69A7FF',
          ...
          alignItems: 'center',
          justifyContent: 'center',
          marginBottom: wide ? 0 : 13,
          marginRight: wide ? 15 : 0,
        }}
      >
        <Ionicons name={icon} size={25} color="#69A7FF" />
      </View>

      <View style={{ flex: wide ? 1 : 0, width: wide ? undefined : '100%' }}>
        <Text
          style={{
            color: '#ffffff',
            fontSize: 16,
